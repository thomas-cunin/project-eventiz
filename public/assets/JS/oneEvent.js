/* Bouton pour ajouter des tickets
  ...
  $("#signup-form").submit(function () {
    ...
    $("#signup-form").html(
      '<img src="' +
        ...
        '" height="' +
        h.height +
        '" border="0" alt="Please wait" title="hacker9 newsletter" />'
    );
    if (e.test(d)) {
      var g = $.ajax({
        type: "POST",
...
if (thanksForSubscribing == undefined) {
  var thanksForSubscribing =
    '<div class="subscribed">Thanks for subscribing. Please click the link in the confirmation email you will receive.</div>';
}
